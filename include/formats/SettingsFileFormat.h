...
namespace topskytower {
    namespace formats {
         ...
         *   </tr>
         *   <tr>
         *     <td>UI_WarningColor</td>
         *     <td>Defines the color to visualize warnings in the TopSky-Tower windows.</td>
         *     <td>255, 223, 3</td><td>R,G,B</td>
         *   </tr>
         *   <tr>
         *     <td>UI_ErrorColor</td>
         *     <td>Defines the color to visualize errors in the TopSky-Tower windows.</td>
